...
fig1 <- plot_ly(data, x = ~period, width = 1000,
  ...
  umar_layout(annotations = list(x = 0 , y = 1,
                                 text = "Rast dodane vrednosti v srednje nizko tehnolo\u0161ko zahtevnih dejavnostih", showarrow = F,
...
fig2 <- plot_ly(data2, x = ~period, width = 1000,
  ...
  umar_layout(annotations = list(x = 0 , y = 1,
                                 text = "Rast dodane vrednosti v srednje visoko tehnolo\u0161ko zahtevnih dejavnostih", showarrow = F,
                                 xref='paper', yref='paper'))
...
fig3 <- plot_ly(data3, x = ~period, width = 1000,
  ...
  umar_layout(annotations = list(x = 0 , y = 1,
                                 text = "Rast dodane vrednosti v visoko tehnolo\u0161ko zahtevnih dejavnostih", showarrow = F,
                                 xref='paper', yref='paper'))
