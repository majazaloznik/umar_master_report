...
```
## Prispevki agregatov potrošnje k rasti BDP - neto izvoz
...
```
## Četrtletna rast BDP in agregatov potrošnje
...
## Četrtletna rast dodane vrednosti in posameznih dejavnosti
...
```
## Dohodkovna struktura BDP - delež
