...
## Predelovalne dejavnosti - rasto dodane vrednosti
...
<!-- ## Rast zaposlenosti v predelovalnih dejavnostih, medletno + povprečna medletna rast -->

<!-- ```{r, code=readLines("children/html_83_medletna_rast_zaposlenosti_predelovalne_s_povprecno_medletno.R"), echo=FALSE, message=FALSE,  warning = FALSE} -->
<!-- ``` -->
 
## Poslovne tendence v predelovalnih dejavnostih, četrtletno
...
<!-- ## Rast proizvodnje po tehnološki zahtevnosti predelovalnih dejavnosti, medletno po četrtletjih -->

<!-- ```{r, code=readLines("children/html_86_rast_proizvodnje_tz_medletno.R", encoding = "UTF-8"), echo=FALSE, message=FALSE,  warning = FALSE} -->
<!-- ``` -->

## Rast proizvodnje po tehnološki zahtevnosti predelovalnih dejavnosti po tehnološki zahtevnosti
