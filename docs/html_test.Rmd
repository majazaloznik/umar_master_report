...
```{r, code=readLines("children/html_89_rast_proizvodnje_predelovalne_po_tehn_z_medletne.R", encoding = "UTF-8"), echo=FALSE, message=FALSE,  warning = FALSE}
```
...
## Rast proizvodnje v industriji - medletno, del. dnem prilagojeni podatki

```{r, code=readLines("children/html_91_rast_proizvodnje_industrija_medletna-prilagojena.R", encoding = "UTF-8"), echo=FALSE, message=FALSE,  warning = FALSE}
```
